...
export const dnaRnaPatternFinderMetadata = {
  ...
  tags: ["DNA", "RNA", "IUPAC", "motif", "regex", "search"],
  summary:
  ...
  options: [
    ...
    },
    {
      ...
      type: "radio",
      label: "Pattern mode",
      help: "Plain text searches for exact characters. IUPAC motif expands ambiguity codes. JavaScript regex treats the pattern as a regular expression.",
      defaultValue: "iupac",
      choices: [
    ...
    { id: "keepGaps", type: "checkbox", label: "Keep gap characters (. and -)", defaultValue: false, help: "Keeps alignment gaps in the searched sequence. Gap characters can affect reported positions and regex behavior." },
    {
      id: "outputFormat",
      type: "radio",
      label: "Output format",
    ...
    },
    {
      id: "patternNote",
      type: "note",
      text: "IUPAC motif mode treats ambiguity codes as matching symbols with overlapping possible bases. Coordinates are 1-based and inclusive on the original sequence."
    }
  ]
};
